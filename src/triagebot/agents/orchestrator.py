...
from triagebot.models.scoring import ConfidenceScorer, classify_confidence
...
You are the AutoTriage orchestrator — a Kubernetes-first production troubleshooting agent.
...
def log_analyzer(query: str, services: str, time_range: str = "15m") -> str:
    ...
    from triagebot.agents.log_analyzer import analyze_logs
...
def metrics_analyzer(query: str, services: str, time_range: str = "15m") -> str:
    ...
    from triagebot.agents.metrics_analyzer import analyze_metrics
...
def graph_query(query_type: str, service_name: str) -> str:
    ...
    from triagebot.mcp_server import query_graph
...
def graph_blast_radius(service_name: str, max_depth: int = 3) -> str:
    ...
    from triagebot.mcp_server import blast_radius
