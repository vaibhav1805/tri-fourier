...
def main(argv: list[str] | None = None) -> None:
    """Run Trifourier from the command line."""
    ...
    # trifourier investigate "checkout service is slow"
    ...
    if args.command == "version":
        from trifourier import __version__

        print(f"trifourier {__version__}")
    elif args.command == "serve":
        import uvicorn

        uvicorn.run("trifourier.api.server:app", host=args.host, port=args.port, workers=1)
